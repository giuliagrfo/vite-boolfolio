...
<template>
    <div>
        <div class="container">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias iure, eius quo sint explicabo, ratione non
                eum
                cumque tempora laboriosam aliquam saepe quasi recusandae natus officia voluptate? Perspiciatis quasi
                laborum enim
                similique obcaecati harum aperiam delectus velit exercitationem! Nobis a natus ullam qui fuga fugit
                cumque quos
                ...
                adipisci
                laudantium sint? Voluptatum eaque nostrum sapiente doloribus iste, rerum reiciendis animi, tempora
                molestias
                libero at nisi dolores quaerat sit officiis mollitia optio numquam. Suscipit autem expedita nesciunt in,
                dolorem
                nisi libero assumenda repellendus minus itaque! Tempore vitae animi commodi veritatis consectetur quas
                ad,
                deleniti iure porro quo enim cupiditate quam, laudantium vel illum doloribus, repellendus accusamus aut.
                Assumenda
                hic rem quidem qui suscipit dolor maxime ab odio voluptatem consectetur velit ipsa numquam, sunt eaque
                quae
